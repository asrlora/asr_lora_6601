...
/**
 * @brief ADC reference voltage definition
 */
typedef enum {
    ADC_EXTERNAL_REF_VOLTAGE = 0x0,     /*ADC external reference voltage*/
    ADC_INTERNAL_REF_VOLTAGE = 0x1,     /*ADC internal reference voltage*/
} adc_ref_voltage_t;
...
void adc_config_sample_sequence(adc_sample_seq_chan_t sample_seq_chan, adc_sample_chan_t sample_chan);
